const Share = () => {
  return(
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8.59 13.51L15.42 17.49" stroke="#9A9CB5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M15.41 6.51L8.59 10.49" stroke="#9A9CB5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
};
